...
public abstract class TableOperator {
	 ...
	 * 表对象
	 */
	protected TableEntity<? extends ColumnEntity> table;
	/**
	 * jdbc
	 */
	 ...
	 * @param jdbcTemplate
	 */
	public TableOperator(TableEntity<? extends ColumnEntity> table, JdbcTemplate jdbcTemplate) {
		super();
		this.table = table;
	...
	public void syncColumn() {
		...
		for (ColumnEntity c : getDbTable().getColumns()) {
