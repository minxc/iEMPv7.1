...
public class DefaultQueryField implements QueryField {
    ...
    public DefaultQueryField(String field, QueryOperator compare, Object value) {
        this.field = field;
        this.compare = compare;
        this.value = value;

        if (QueryOperator.IN.equals(compare) || QueryOperator.NOT_IN.equals(compare)) {
    ...
    public void setCompare(QueryOperator compare) {
        this.compare = compare;
    }

    public String getSql() {
        if (compare == null) {
            compare = QueryOperator.EQUAL;
        }
        String fieldParam;
        if (field.indexOf(".") > -1) {
