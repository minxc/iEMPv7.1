package org.minxc.emp.common.db.table.colmap;
...
* 项目名称：common-db   
* 类名称：MySQLColumnMap   
* 类 mysql 列的元数据到columnmodel的映射,用于从数据库元数据读取到列对象。  
* 创建人：Xianchang.min   
...
public class MySQLColumnMap implements RowMapper<Column> {
    ...
    public Column mapRow(ResultSet rs, int row) throws SQLException {
        ...
        column_comment = MySQLTableMetadata.getComments(column_comment, name);
        int iLength = 0;
        try {
