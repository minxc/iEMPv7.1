...
public interface BpmnProcessDefinitionService {
     ...
     * @return
     */
    BpmnDefinition getDefinitionById(String defId);

    BpmnDefinition getDefinitionByActDefId(String actDefId);
    ...
    BpmProcessDef initBpmProcessDef(BpmnDefinition bpmDef);
