...
public class BpmnContext {
     ...
     */
    private static ThreadLocal<Map<String, BpmnProcessDef>> threadBpmProcessDef = new ThreadLocal<>();
    ...
    public static BpmnProcessDef getProcessDef(String defId) {
        Map<String, BpmnProcessDef> map = getThreadMap(threadBpmProcessDef);
        return map.get(defId);
    }

    public static void addProcessDef(String defId, BpmnProcessDef processDef) {
