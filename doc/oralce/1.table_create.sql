...
COMMENT ON TABLE YMMG_RESOURCE IS '子系统资源';
COMMENT ON COLUMN YMMG_RESOURCE.ID IS '主键';
COMMENT ON COLUMN YMMG_RESOURCE.SYSTEM_ID IS '子系统ID';
COMMENT ON COLUMN YMMG_RESOURCE.ALIAS IS '子系统中独一无二';
...
COMMENT ON TABLE YMMG_SUBSYSTEM IS '子系统定义';
COMMENT ON COLUMN YMMG_SUBSYSTEM.ID IS '主键';
COMMENT ON COLUMN YMMG_SUBSYSTEM.NAME IS '系统名称';
COMMENT ON COLUMN YMMG_SUBSYSTEM.ALIAS IS '系统别名';
COMMENT ON COLUMN YMMG_SUBSYSTEM.LOGO IS 'LOGO地址';
COMMENT ON COLUMN YMMG_SUBSYSTEM.ENABLED IS '是否可用1:可用0:不可用';
COMMENT ON COLUMN YMMG_SUBSYSTEM.HOME_URL IS '主页地址';
COMMENT ON COLUMN YMMG_SUBSYSTEM.BASE_URL IS '基础地址';
COMMENT ON COLUMN YMMG_SUBSYSTEM.TENANT IS '租户名称';
COMMENT ON COLUMN YMMG_SUBSYSTEM.NOTES IS '备注';
COMMENT ON COLUMN YMMG_SUBSYSTEM.CREATOR_ID IS '创建人ID';
COMMENT ON COLUMN YMMG_SUBSYSTEM.CREATOR IS '创建人';
COMMENT ON COLUMN YMMG_SUBSYSTEM.CREATE_TIME IS '创建时间';
COMMENT ON COLUMN YMMG_SUBSYSTEM.IS_DEFAULT IS '是否默认1:可用0:不可用';
