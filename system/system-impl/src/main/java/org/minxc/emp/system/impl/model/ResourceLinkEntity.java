...
import org.minxc.emp.system.api.model.ResourceLink;


/**
 * 关联资源 实体对象
 */
public class ResourceLinkEntity implements IdModel,ResourceLink {

	private static final long serialVersionUID = -6628128792001831729L;
    ...
    public boolean equals(Object obj) {
        ...
        if (getClass() != obj.getClass())
            return false;
        ResourceLinkEntity other = (ResourceLinkEntity) obj;
        if (id == null) {
            if (other.id != null)
                return false;
