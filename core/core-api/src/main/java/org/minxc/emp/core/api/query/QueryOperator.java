...
public enum QueryOperator {
    ...
    private QueryOperator(String val, String op, String desc, String[] supports) {
        this.val = val;
        this.op = op;
        this.desc = desc;
     ...
     * @since 1.0.0
     */
    public static QueryOperator getByOP(String op) {
        for (QueryOperator queryOP : values()) {
            if (queryOP.operator().equals(op)) {
                return queryOP;
            }
        }
        return null;
    ...
    public static QueryOperator getByVal(String val) {
        for (QueryOperator queryOP : values()) {
