...
public class BeanCopierUtils {
    ...
    protected static final Logger LOG = LoggerFactory.getLogger(BeanCopierUtils.class);
    ...
    public static void copyProperties(Object source, Object target) {
        ...
        BeanCopier copier = getBeanCopierByKey(beanCopierMap, beanKey, source, target);
     ...
     * @return
     */
    private static BeanCopier getBeanCopierByKey(Map<String, BeanCopier> beanCopierMap, String beanKey,
